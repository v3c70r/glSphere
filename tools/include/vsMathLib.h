...
#define MATH_ZERO		1.0E-6
#define IS_ZERO(x)		(fabs(x) < MATH_ZERO)
	...
	public:
		...
		*/
		...
		/** Similar to glLoadIdentity.
		  ...
		  * \param aType any value from MatrixTypes
		*/
		void loadIdentity(ComputedMatrixTypes aType);
		...
		*/
		void get(MatrixTypes aType, float *res);
		...
		/** Similar to glGet for computed matrices
		  ...
		  * \returns pointer to the matrix (float[16])
		*/
		void get(ComputedMatrixTypes aType, float* res);
		...
		*/
         ...
         * \param x,y,z rotation aix
         * \param res the output result matrix
         * */
        static void createRotationMatrix(float angle, float x, float y, float z, float *res);

        /** Map screen coordinate to a sphere whose radius is 1
         *  
         *  \param x,y location of the mouse
         *  \param w,h size of the window
		  * \param res the ouput result vector, a float[3]
        */
        static void mapScreen2Sphere( float x, float y, float w, float h, float *res);
